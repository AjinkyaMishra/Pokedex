...
// Prefer dream-world for 1–649, otherwise use sprites from API response
let imageUrl;

if (id <= 649 && pokemon.sprites.other["dream_world"].front_default) {
  imageUrl = pokemon.sprites.other["dream_world"].front_default;
} else if (pokemon.sprites.other["official-artwork"].front_default) {
  imageUrl = pokemon.sprites.other["official-artwork"].front_default;
} else if (pokemon.sprites.front_default) {
  imageUrl = pokemon.sprites.front_default; // fallback
} else {
  imageUrl = "fallback.png"; // optional local placeholder
}
